...
SELECT
    ...
    ce.end_time,
    ce.transcription,
    COALESCE(ce.start_time, to_timestamp(cd.start_time_unix_secs), cd.created_at) AS event_ts,
    r.folio,
...
VALUES (
    '20260313_005_rebuild_views_without_legacy_columns',
    'Rebuild dashboard views without updated_at, acc_number, acc_holder, amount'
)
